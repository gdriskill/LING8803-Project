...
in_file = open('adj-adj-noun_phrases_all.txt', 'r')
examples_file = open('interesting_examples_all.txt', 'w')
distances_file = open('distance_scores_all.csv', 'w')
scores_both_file = open('scores_both_all.txt', 'w')
