...
in_file = open('adj-adj-noun_phrases_speeches-final.txt', 'r')
examples_file = open('interesting_examples_speeches.txt', 'w')
distances_file = open('distance_scores_speeches.csv', 'w')
scores_both_file = open('scores_both_speeches.txt', 'w')
...
distances_file.write("adjective, subjectivity, distance, count \n")
